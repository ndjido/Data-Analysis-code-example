-- Define parameters
%default agg_validations_data_file_path '/user/hypercube/keolis_data/agg_validations.csv'
%default liste_periode_data_file_path '/user/hypercube/keolis_data/liste_periodes-2.csv'
